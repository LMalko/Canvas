...
class ControllerAttendanceContainer():
    ...
    def __init__(self, attendance_container_object):
        self.attendance_container = attendance_container_object
    ...
    def add_student_attendance(self, attendance_object):
        self.attendance_container.add_student_attendance(attendance_object)
    ...
    def del_student_attendance(self, attendance_object):
        self.attendance_container.del_student_attendance(attendance_object)
